...
class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    void addBook(String book_title, String book_author, int book_pages) {
        ...
        cv.put(COLUMN_PAGES, book_pages);
    ...
    void updateData(String row_id, String title, String author, String pages){
        ...
        if (result == -1) {
            ...
            Toast.makeText(context, "Updated Successfully", LENGTH_SHORT).show();
        }
    }
    ...
    void deleteOneRow(String row_id){
        ...
        if(result==-1){
            ...
            Toast.makeText(context, "Successfully deleted", LENGTH_SHORT).show();
        }
    }
